...
| RNF-002 | Las métricas clínicas de los modelos de IA deben alcanzar los objetivos definidos por el profesor: **sensibilidad >95%, especificidad >90%, AUC-ROC >0.97, recall >94%, precisión BI-RADS >93%**, medidas frente al dataset de referencia correspondiente. | Propuesto | `services/mammography` (y futuras modalidades) | — |
